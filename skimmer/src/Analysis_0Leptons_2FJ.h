#ifndef ANALYSIS_0LEPTONS_2FJ_H
#define ANALYSIS_0LEPTONS_2FJ_H
...
class Analysis_0Leptons_2FJ : public Analysis
{
  public:
    // Constructor
    Analysis_0Leptons_2FJ(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
