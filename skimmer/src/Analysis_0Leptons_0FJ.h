...
class Analysis_0Leptons_0FJ : public Analysis
{
  public:
    // Constructor
    Analysis_0Leptons_0FJ(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
    ...
    void initCutflow() override
    {
        ...
        // Lepton selection
        Cut *cut_atleast8jets = new LambdaCut("AtLeast8Jets", [&]() { return (cutflow.globals.getVal<int>("n_vvh_veto_jets") >= 8); });
