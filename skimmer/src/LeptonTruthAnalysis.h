...
struct LeptonTruthAnalysis
{
    ...
    LeptonTruthAnalysis(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref) : arbusto(arbusto_ref), nt(nt_ref), cli(cli_ref) { std::cout << "Initialize Lepton Truth Analysis object" << std::endl; };
