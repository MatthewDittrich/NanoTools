...
class SkimmerCut : public Cut
{
  public:
    ...
    SkimmerCut(std::string cut_name, Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Cut(cut_name), arbusto(arbusto_ref), nt(nt_ref), cli(cli_ref), globals(cutflow_ref.globals) {};
};
...
class FindLeptons : public SkimmerCut
{
  public:
    ...
    //                                                             // Do nothing
    //                                                         };
    FindLeptons(std::string cut_name, Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : SkimmerCut(cut_name, arbusto_ref, nt_ref, cli_ref, cutflow_ref) {};
