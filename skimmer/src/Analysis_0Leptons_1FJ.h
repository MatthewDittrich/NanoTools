#ifndef ANALYSIS_0LEPTONS_1FJ_H
#define ANALYSIS_0LEPTONS_1FJ_H
...
class Analysis_0Leptons_1FJ : public Analysis
{
  public:
    // Constructor
    Analysis_0Leptons_1FJ(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
    ...
    void initCutflow() override
    {
        ...
        Cut *cut_atleast5jets = new LambdaCut("AtLeast5Jets", [&]() { return (cutflow.globals.getVal<int>("n_vvh_veto_jets") >= 5); });
        vCutflowCuts_.push_back(cut_atleast5jets);

        finalSkimmerCut_ = "AtLeast5Jets";
