#ifndef ANALYSIS_SIG_H
#define ANALYSIS_SIG_H
...
class Analysis_Sig : public Analysis
{
  public:
    // Constructor
    Analysis_Sig(Arbusto &arbusto_ref, Nano &nt_ref, HEPCLI &cli_ref, Cutflow &cutflow_ref) : Analysis(arbusto_ref, nt_ref, cli_ref, cutflow_ref) {}
    ...
    void initCutflow() override
    {
        ...
        Cut *cut_dummy = new LambdaCut("DummyCut", [&]() { return true; });
        vCutflowCuts_.push_back(cut_dummy);

        finalSkimmerCut_ = "DummyCut";
